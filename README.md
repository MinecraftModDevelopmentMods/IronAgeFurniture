...
[![Build, test, and audit](https://github.com/MinecraftModDevelopmentMods/IronAgeFurniture/actions/workflows/ci.yml/badge.svg?branch=master-1.19)](https://github.com/MinecraftModDevelopmentMods/IronAgeFurniture/actions/workflows/ci.yml?query=branch%3Amaster-1.19)
...
This branch provides IronAgeFurniture `0.3.0.119041` for Minecraft 1.19.4 and
Forge 45.4.0. It requires Java 17 and can be installed on both clients and
dedicated servers.
...
1.19.4 worlds therefore retain the same runtime identities.
