...
For Minecraft 26.3 NeoForge, the target is `2603002`, so the current functionally equivalent `0.3.0` release is `0.3.0.2603002`. The release tag is exactly that complete version.
