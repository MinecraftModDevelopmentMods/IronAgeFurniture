...
For Minecraft 1.21.1 NeoForge, the target is `121012`, so the current functionally equivalent `0.3.0` release is `0.3.0.121012`. The release tag is exactly that complete version.
