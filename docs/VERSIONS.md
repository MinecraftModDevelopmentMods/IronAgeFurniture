...
For Minecraft 1.21.11 Forge, the target is `121111`, so the current functionally equivalent `0.3.0` release is `0.3.0.121111`. The release tag is exactly that complete version.
