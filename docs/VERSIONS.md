...
For Minecraft 1.19.4 Forge, the target is `119041`, so the current functionally equivalent `0.3.0` release is `0.3.0.119041`. The release tag is exactly that complete version.
