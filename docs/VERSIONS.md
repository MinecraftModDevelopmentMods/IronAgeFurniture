...
For Minecraft 26.2 NeoForge, the target is `2602002`, so the current functionally equivalent `0.3.0` release is `0.3.0.2602002`. The release tag is exactly that complete version.
