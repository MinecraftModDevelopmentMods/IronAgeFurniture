...
For Minecraft 1.20.6 NeoForge, the target is `120062`, so the current functionally equivalent `0.3.0` release is `0.3.0.120062`. The release tag is exactly that complete version.
