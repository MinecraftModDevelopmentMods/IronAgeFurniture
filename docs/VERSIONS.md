...
For Minecraft 26.3 Forge, the target is `2603001`, so the current functionally equivalent `0.3.0` release is `0.3.0.2603001`. The release tag is exactly that complete version.
