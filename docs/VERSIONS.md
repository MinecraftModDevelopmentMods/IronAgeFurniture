...
For Minecraft 26.1.2 Forge, the target is `2601021`, so the current functionally equivalent `0.3.0` release is `0.3.0.2601021`. The release tag is exactly that complete version.
