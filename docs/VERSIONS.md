...
For Minecraft 1.21.1 Forge, the target is `121011`, so the current functionally equivalent `0.3.0` release is `0.3.0.121011`. The release tag is exactly that complete version.
