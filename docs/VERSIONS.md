...
For Minecraft 1.16.5 Forge, the target is `116051`, so this Phase 3 release is `0.3.0.116051`. The release tag is exactly that complete version.
...
The 1.16.5 release contains the upgrade bridge for supported furniture and
...
boundary; a world saved by 1.16.5 cannot safely return to an older game version.
