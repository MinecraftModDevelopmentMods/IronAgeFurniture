...
For Minecraft 26.2 Forge, the target is `2602001`, so the current functionally equivalent `0.3.0` release is `0.3.0.2602001`. The release tag is exactly that complete version.
