...
For Minecraft 1.21.11 NeoForge, the target is `121112`, so the current functionally equivalent `0.3.0` release is `0.3.0.121112`. The release tag is exactly that complete version.
