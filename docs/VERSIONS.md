...
For Minecraft 26.1.2 NeoForge, the target is `2601022`, so the current functionally equivalent `0.3.0` release is `0.3.0.2601022`. The release tag is exactly that complete version.
