...
public class ItemInitialiser {
    ...
    public static void registerItems(RegistryEvent.Register<Item> event) {
    	...
    	event.getRegistry().registerAll(
    			...
    			new BlockItem(BlockObjectHolder.chair_wood_ironage_bench_single_oak, new BlockItem.Properties().group(Ironagefurniture.IAF_GROUP)).setRegistryName(Ironagefurniture.MODID, BlockObjectHolder.chair_wood_ironage_bench_single_oak.getRegistryName().getPath()),
    			new BlockItem(BlockObjectHolder.chair_wood_ironage_bench_single_acacia, new BlockItem.Properties().group(Ironagefurniture.IAF_GROUP)).setRegistryName(Ironagefurniture.MODID, BlockObjectHolder.chair_wood_ironage_bench_single_acacia.getRegistryName().getPath()),
    			new BlockItem(BlockObjectHolder.chair_wood_ironage_bench_single_dark_oak, new BlockItem.Properties().group(Ironagefurniture.IAF_GROUP)).setRegistryName(Ironagefurniture.MODID, BlockObjectHolder.chair_wood_ironage_bench_single_dark_oak.getRegistryName().getPath()),
    			new BlockItem(BlockObjectHolder.chair_wood_ironage_bench_single_birch, new BlockItem.Properties().group(Ironagefurniture.IAF_GROUP)).setRegistryName(Ironagefurniture.MODID, BlockObjectHolder.chair_wood_ironage_bench_single_birch.getRegistryName().getPath()),
    			new BlockItem(BlockObjectHolder.chair_wood_ironage_bench_single_jungle, new BlockItem.Properties().group(Ironagefurniture.IAF_GROUP)).setRegistryName(Ironagefurniture.MODID, BlockObjectHolder.chair_wood_ironage_bench_single_jungle.getRegistryName().getPath()),
    			new BlockItem(BlockObjectHolder.chair_wood_ironage_bench_single_spruce, new BlockItem.Properties().group(Ironagefurniture.IAF_GROUP)).setRegistryName(Ironagefurniture.MODID, BlockObjectHolder.chair_wood_ironage_bench_single_spruce.getRegistryName().getPath())
