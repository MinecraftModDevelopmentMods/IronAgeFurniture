...
//	private static void registerChairs(String[] woodTypes, boolean log, String[] netherWoodTypes) {
//		for (String wood : woodTypes) {
//			registerChairItems(log, wood);
//		}
//		
...
//	}
//
//	private static void registerChairItems(boolean log, String wood) {
//		
//		// public static final RegistryObject<Item> EXAMPLE_BLOCK_ITEM = ITEMS.register("example_block", () -> new BlockItem(EXAMPLE_BLOCK.get(), new Item.Properties()));
//		if (IronAgeFurnitureConfiguration.CLIENT.GENERATE_CLASSIC_CHAIRS.get())
//			registerAndAssignItem("chair_wood_ironage_classic_" + wood);
//
...
//	}
//
//	private static void registerAndAssignItem(String fieldName) {
//		//public static final RegistryObject<Item> EXAMPLE_BLOCK_ITEM = ITEMS.register("example_block", () -> new BlockItem(EXAMPLE_BLOCK.get(), new Item.Properties()));
//	    try {
//	        Field field = BlockObjectHolder.class.getDeclaredField(fieldName);
//	        field.setAccessible(true);
//	        
//	        RegistryObject<Block> blockInstance = (RegistryObject<Block>) field.get(null);
//	        Ironagefurniture.ITEMS.register(fieldName, () -> new BlockItem(blockInstance.get(), new Item.Properties()));
//	        
...
//	}
//	
////	private static void registerItem(Block theBlock) {
////		
...
//		registerChairs(VANILLA_WOOD_TYPES, true, VANILLA_NETHER_WOOD_TYPES);
//
