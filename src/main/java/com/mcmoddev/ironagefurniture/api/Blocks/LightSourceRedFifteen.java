...
public class LightSourceRedFifteen extends LightSourceRed {
	...
	public LightSourceRedFifteen(Properties properties) {
		super(properties);
	...
	public LightSourceRedFifteen(float hardness, float blastResistance, SoundType sound, String name) {
