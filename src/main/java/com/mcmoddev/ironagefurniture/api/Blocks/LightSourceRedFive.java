...
public class LightSourceRedFive extends LightSourceRed {
	...
	public LightSourceRedFive(Properties properties) {
		super(properties);
	...
	public LightSourceRedFive(float hardness, float blastResistance, SoundType sound, String name) {
