...
public class LightSourceSconceCandleFloorUnlit extends LightSourceSconceCandleFloor {
    public LightSourceSconceCandleFloorUnlit(Material materialIn, String name, float resistance, float hardness, int candleCount) {
