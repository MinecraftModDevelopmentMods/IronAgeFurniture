...
public class LightSourceSconceRedFloor extends LightSourceSconceGlowFloor {
    ...
    public LightSourceSconceRedFloor(Material materialIn, String name, float resistance, float hardness, int lightLevel) {
    ...
    protected int getNeighborSignal(World worldIn, BlockPos pos, IBlockState state) {
        return worldIn.getRedstonePower(pos.down(), EnumFacing.DOWN);
    }

    protected Block getBlockBySignalLevel(int signal) {
        switch (signal) {
            case 1:
                return BlockObjectHolder.light_metal_ironage_sconce_floor_red_iron_one;
            case 2:
                return BlockObjectHolder.light_metal_ironage_sconce_floor_red_iron_two;
            case 3:
                return BlockObjectHolder.light_metal_ironage_sconce_floor_red_iron_three;
            case 4:
                return BlockObjectHolder.light_metal_ironage_sconce_floor_red_iron_four;
            case 5:
                return BlockObjectHolder.light_metal_ironage_sconce_floor_red_iron_five;
            case 6:
                return BlockObjectHolder.light_metal_ironage_sconce_floor_red_iron_six;
            case 7:
                return BlockObjectHolder.light_metal_ironage_sconce_floor_red_iron_seven;
            case 8:
                return BlockObjectHolder.light_metal_ironage_sconce_floor_red_iron_eight;
            case 9:
                return BlockObjectHolder.light_metal_ironage_sconce_floor_red_iron_nine;
            case 10:
                return BlockObjectHolder.light_metal_ironage_sconce_floor_red_iron_ten;
            case 11:
                return BlockObjectHolder.light_metal_ironage_sconce_floor_red_iron_eleven;
            case 12:
                return BlockObjectHolder.light_metal_ironage_sconce_floor_red_iron_twelve;
            case 13:
                return BlockObjectHolder.light_metal_ironage_sconce_floor_red_iron_thirteen;
            case 14:
                return BlockObjectHolder.light_metal_ironage_sconce_floor_red_iron_fourteen;
            case 15:
                return BlockObjectHolder.light_metal_ironage_sconce_floor_red_iron_fifteen;
            default:
