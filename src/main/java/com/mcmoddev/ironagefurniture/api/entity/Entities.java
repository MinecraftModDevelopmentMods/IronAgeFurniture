...
public class Entities
{
    ...
    public static final EntityType<Seat> SEAT = buildType("ironagefurniture:seat", EntityType.Builder.<Seat>of((type, world) -> new Seat(world), EntityClassification.MISC).sized(0.0F, 0.0F).setCustomClientFactory((spawnEntity, world) -> new Seat(world)));
