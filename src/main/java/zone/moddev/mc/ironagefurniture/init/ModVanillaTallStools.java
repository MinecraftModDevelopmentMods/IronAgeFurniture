...
public class ModVanillaTallStools {
	...
	public static DeferredHolder<Block, Block> chair_wood_ironage_stool_tall_pale_oak = register("chair_wood_ironage_stool_tall_pale_oak", () -> new TallStool(1, 10, SoundType.WOOD, "chair_wood_ironage_stool_tall_pale_oak"));
