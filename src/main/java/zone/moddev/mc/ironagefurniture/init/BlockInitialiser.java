	...
	private static void generateChairs() {
		...
		if (IronAgeFurnitureConfiguration.INTEGRATION_IMMERSIVEENGINEERING && Loader.isModLoaded("immersiveengineering")) {
			...
			if (IronAgeFurnitureConfiguration.GENERATE_WOOD_BENCHES) {
				...
				BlockObjectHolder.chair_wood_ironage_bench_padded_single_immersiveengineering_treatedWood = FurnitureFactory.CreateWoodPaddedBench("chair_wood_ironage_bench_padded_single_immersiveengineering_treatedWood");
				...
				BlockObjectHolder.chair_wood_ironage_bench_back_padded_single_immersiveengineering_treatedWood = FurnitureFactory.CreateWoodPaddedBackBench("chair_wood_ironage_bench_back_padded_single_immersiveengineering_treatedWood");
			}
		}
