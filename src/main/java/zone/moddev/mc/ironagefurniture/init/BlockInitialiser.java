...
public class BlockInitialiser {
	...
	private static void generateChairs() {
		...
		if (IronAgeFurnitureConfiguration.GENERATE_WOOD_BENCHES) {
			...
			BlockObjectHolder.chair_wood_ironage_bench_padded_single_oak = FurnitureFactory.CreateWoodPaddedBench("chair_wood_ironage_bench_padded_single_oak");
			BlockObjectHolder.chair_wood_ironage_bench_padded_single_acacia = FurnitureFactory.CreateWoodPaddedBench("chair_wood_ironage_bench_padded_single_acacia"); 
			BlockObjectHolder.chair_wood_ironage_bench_padded_single_big_oak = FurnitureFactory.CreateWoodPaddedBench("chair_wood_ironage_bench_padded_single_big_oak");
			BlockObjectHolder.chair_wood_ironage_bench_padded_single_birch = FurnitureFactory.CreateWoodPaddedBench("chair_wood_ironage_bench_padded_single_birch");
			BlockObjectHolder.chair_wood_ironage_bench_padded_single_jungle = FurnitureFactory.CreateWoodPaddedBench("chair_wood_ironage_bench_padded_single_jungle");
			BlockObjectHolder.chair_wood_ironage_bench_padded_single_spruce = FurnitureFactory.CreateWoodPaddedBench("chair_wood_ironage_bench_padded_single_spruce");
			...
			BlockObjectHolder.chair_wood_ironage_bench_back_padded_single_oak = FurnitureFactory.CreateWoodPaddedBackBench("chair_wood_ironage_bench_back_padded_single_oak");
			BlockObjectHolder.chair_wood_ironage_bench_back_padded_single_acacia = FurnitureFactory.CreateWoodPaddedBackBench("chair_wood_ironage_bench_back_padded_single_acacia"); 
			...
			BlockObjectHolder.chair_wood_ironage_bench_back_padded_single_birch = FurnitureFactory.CreateWoodPaddedBackBench("chair_wood_ironage_bench_back_padded_single_birch");
			BlockObjectHolder.chair_wood_ironage_bench_back_padded_single_jungle = FurnitureFactory.CreateWoodPaddedBackBench("chair_wood_ironage_bench_back_padded_single_jungle");
			BlockObjectHolder.chair_wood_ironage_bench_back_padded_single_spruce = FurnitureFactory.CreateWoodPaddedBackBench("chair_wood_ironage_bench_back_padded_single_spruce");
		}

		
		if (IronAgeFurnitureConfiguration.INTEGRATION_IMMERSIVEENGINEERING && Loader.isModLoaded("immersiveengineering")) {
			if (IronAgeFurnitureConfiguration.GENERATE_CLASSIC_CHAIRS) {
				BlockObjectHolder.chair_wood_ironage_classic_immersiveengineering_treatedWood = FurnitureFactory.CreateWoodChair("chair_wood_ironage_classic_immersiveengineering_treated_wood");
			}
			
			if (IronAgeFurnitureConfiguration.GENERATE_SHIELD_CHAIRS) {
				BlockObjectHolder.chair_wood_ironage_shield_immersiveengineering_treatedWood = FurnitureFactory.CreateWoodShieldChair("chair_wood_ironage_shield_immersiveengineering_treated_wood");
			}
			
			if (IronAgeFurnitureConfiguration.GENERATE_SHORT_STOOLS) {
				BlockObjectHolder.chair_wood_ironage_stool_short_immersiveengineering_treatedWood =  FurnitureFactory.CreateWoodShortStool("chair_wood_ironage_stool_short_immersiveengineering_treated_wood");
			}
			
			if (IronAgeFurnitureConfiguration.GENERATE_TALL_STOOLS) {
				BlockObjectHolder.chair_wood_ironage_stool_tall_immersiveengineering_treatedWood = FurnitureFactory.CreateWoodTallStool("chair_wood_ironage_stool_tall_immersiveengineering_treated_wood");
			}
			
			if (IronAgeFurnitureConfiguration.GENERATE_WOOD_BENCHES) {
				BlockObjectHolder.chair_wood_ironage_bench_single_immersiveengineering_treatedWood = FurnitureFactory.CreateWoodBench("chair_wood_ironage_bench_single_immersiveengineering_treated_wood");
				BlockObjectHolder.chair_wood_ironage_bench_padded_single_immersiveengineering_treatedWood = FurnitureFactory.CreateWoodPaddedBench("chair_wood_ironage_bench_padded_single_immersiveengineering_treated_wood");
				BlockObjectHolder.chair_wood_ironage_bench_back_single_immersiveengineering_treatedWood = FurnitureFactory.CreateWoodBackBench("chair_wood_ironage_bench_back_single_immersiveengineering_treated_wood");
				BlockObjectHolder.chair_wood_ironage_bench_back_padded_single_immersiveengineering_treatedWood = FurnitureFactory.CreateWoodPaddedBackBench("chair_wood_ironage_bench_back_padded_single_immersiveengineering_treated_wood");	
			}
		}
		...
		if (IronAgeFurnitureConfiguration.INTEGRATION_BIOMESOPLENTY && Loader.isModLoaded("biomesoplenty")) {
			...
			if (IronAgeFurnitureConfiguration.GENERATE_WOOD_BENCHES) {
				...
				BlockObjectHolder.chair_wood_ironage_bench_padded_single_biomesoplenty_cherry 		= 	FurnitureFactory.CreateWoodPaddedBench("chair_wood_ironage_bench_padded_single_biomesoplenty_cherry");
				...
				BlockObjectHolder.chair_wood_ironage_bench_padded_single_biomesoplenty_ethereal 	= 	FurnitureFactory.CreateWoodPaddedBench("chair_wood_ironage_bench_padded_single_biomesoplenty_ethereal");
				...
				BlockObjectHolder.chair_wood_ironage_bench_padded_single_biomesoplenty_jacaranda 	= 	FurnitureFactory.CreateWoodPaddedBench("chair_wood_ironage_bench_padded_single_biomesoplenty_jacaranda");
				BlockObjectHolder.chair_wood_ironage_bench_padded_single_biomesoplenty_magic 		= 	FurnitureFactory.CreateWoodPaddedBench("chair_wood_ironage_bench_padded_single_biomesoplenty_magic");
				BlockObjectHolder.chair_wood_ironage_bench_padded_single_biomesoplenty_mahogany 	= 	FurnitureFactory.CreateWoodPaddedBench("chair_wood_ironage_bench_padded_single_biomesoplenty_mahogany");
				BlockObjectHolder.chair_wood_ironage_bench_padded_single_biomesoplenty_mangrove 	= 	FurnitureFactory.CreateWoodPaddedBench("chair_wood_ironage_bench_padded_single_biomesoplenty_mangrove");
				BlockObjectHolder.chair_wood_ironage_bench_padded_single_biomesoplenty_palm 		= 	FurnitureFactory.CreateWoodPaddedBench("chair_wood_ironage_bench_padded_single_biomesoplenty_palm");
				BlockObjectHolder.chair_wood_ironage_bench_padded_single_biomesoplenty_pine 		= 	FurnitureFactory.CreateWoodPaddedBench("chair_wood_ironage_bench_padded_single_biomesoplenty_pine");
				BlockObjectHolder.chair_wood_ironage_bench_padded_single_biomesoplenty_redwood 		= 	FurnitureFactory.CreateWoodPaddedBench("chair_wood_ironage_bench_padded_single_biomesoplenty_redwood");
				BlockObjectHolder.chair_wood_ironage_bench_padded_single_biomesoplenty_sacred_oak 	= 	FurnitureFactory.CreateWoodPaddedBench("chair_wood_ironage_bench_padded_single_biomesoplenty_sacred_oak");
				BlockObjectHolder.chair_wood_ironage_bench_padded_single_biomesoplenty_umbran 		= 	FurnitureFactory.CreateWoodPaddedBench("chair_wood_ironage_bench_padded_single_biomesoplenty_umbran");
				BlockObjectHolder.chair_wood_ironage_bench_padded_single_biomesoplenty_willow 		= 	FurnitureFactory.CreateWoodPaddedBench("chair_wood_ironage_bench_padded_single_biomesoplenty_willow");
				...
				BlockObjectHolder.chair_wood_ironage_bench_back_padded_single_biomesoplenty_cherry			=	FurnitureFactory.CreateWoodPaddedBackBench("chair_wood_ironage_bench_back_padded_single_biomesoplenty_cherry");
				BlockObjectHolder.chair_wood_ironage_bench_back_padded_single_biomesoplenty_ebony			=	FurnitureFactory.CreateWoodPaddedBackBench("chair_wood_ironage_bench_back_padded_single_biomesoplenty_ebony");
				BlockObjectHolder.chair_wood_ironage_bench_back_padded_single_biomesoplenty_ethereal		=	FurnitureFactory.CreateWoodPaddedBackBench("chair_wood_ironage_bench_back_padded_single_biomesoplenty_ethereal");
				BlockObjectHolder.chair_wood_ironage_bench_back_padded_single_biomesoplenty_eucalyptus		=	FurnitureFactory.CreateWoodPaddedBackBench("chair_wood_ironage_bench_back_padded_single_biomesoplenty_eucalyptus");
				...
				BlockObjectHolder.chair_wood_ironage_bench_back_padded_single_biomesoplenty_hellbark		=	FurnitureFactory.CreateWoodPaddedBackBench("chair_wood_ironage_bench_back_padded_single_biomesoplenty_hellbark");
				BlockObjectHolder.chair_wood_ironage_bench_back_padded_single_biomesoplenty_jacaranda		=	FurnitureFactory.CreateWoodPaddedBackBench("chair_wood_ironage_bench_back_padded_single_biomesoplenty_jacaranda");
				...
				BlockObjectHolder.chair_wood_ironage_bench_back_padded_single_biomesoplenty_mahogany		=	FurnitureFactory.CreateWoodPaddedBackBench("chair_wood_ironage_bench_back_padded_single_biomesoplenty_mahogany");
				...
				BlockObjectHolder.chair_wood_ironage_bench_back_padded_single_biomesoplenty_palm			=	FurnitureFactory.CreateWoodPaddedBackBench("chair_wood_ironage_bench_back_padded_single_biomesoplenty_palm");
				BlockObjectHolder.chair_wood_ironage_bench_back_padded_single_biomesoplenty_pine			=	FurnitureFactory.CreateWoodPaddedBackBench("chair_wood_ironage_bench_back_padded_single_biomesoplenty_pine");
				BlockObjectHolder.chair_wood_ironage_bench_back_padded_single_biomesoplenty_redwood			=	FurnitureFactory.CreateWoodPaddedBackBench("chair_wood_ironage_bench_back_padded_single_biomesoplenty_redwood");
				BlockObjectHolder.chair_wood_ironage_bench_back_padded_single_biomesoplenty_sacred_oak		=	FurnitureFactory.CreateWoodPaddedBackBench("chair_wood_ironage_bench_back_padded_single_biomesoplenty_sacred_oak");
				BlockObjectHolder.chair_wood_ironage_bench_back_padded_single_biomesoplenty_umbran			=	FurnitureFactory.CreateWoodPaddedBackBench("chair_wood_ironage_bench_back_padded_single_biomesoplenty_umbran");
				BlockObjectHolder.chair_wood_ironage_bench_back_padded_single_biomesoplenty_willow			=	FurnitureFactory.CreateWoodPaddedBackBench("chair_wood_ironage_bench_back_padded_single_biomesoplenty_willow");
			}
		}
		...
		if (IronAgeFurnitureConfiguration.INTEGRATION_NATURA && Loader.isModLoaded("natura")) {
			...
			if (IronAgeFurnitureConfiguration.GENERATE_WOOD_BENCHES) {
				...
				BlockObjectHolder.chair_wood_ironage_bench_padded_single_natura_silverbell = FurnitureFactory.CreateWoodPaddedBench("chair_wood_ironage_bench_padded_single_natura_silverbell");
				BlockObjectHolder.chair_wood_ironage_bench_padded_single_natura_tiger = FurnitureFactory.CreateWoodPaddedBench("chair_wood_ironage_bench_padded_single_natura_tiger");
				BlockObjectHolder.chair_wood_ironage_bench_padded_single_natura_willow = FurnitureFactory.CreateWoodPaddedBench("chair_wood_ironage_bench_padded_single_natura_willow");
				BlockObjectHolder.chair_wood_ironage_bench_padded_single_natura_bloodwood = FurnitureFactory.CreateWoodPaddedBench("chair_wood_ironage_bench_padded_single_natura_bloodwood");
				...
				BlockObjectHolder.chair_wood_ironage_bench_padded_single_natura_fusewood = FurnitureFactory.CreateWoodPaddedBench("chair_wood_ironage_bench_padded_single_natura_fusewood");
				...
				BlockObjectHolder.chair_wood_ironage_bench_back_padded_single_natura_silverbell = FurnitureFactory.CreateWoodPaddedBackBench("chair_wood_ironage_bench_back_padded_single_natura_silverbell");
				BlockObjectHolder.chair_wood_ironage_bench_back_padded_single_natura_tiger 		= FurnitureFactory.CreateWoodPaddedBackBench("chair_wood_ironage_bench_back_padded_single_natura_tiger");
				BlockObjectHolder.chair_wood_ironage_bench_back_padded_single_natura_willow 	= FurnitureFactory.CreateWoodPaddedBackBench("chair_wood_ironage_bench_back_padded_single_natura_willow");
				BlockObjectHolder.chair_wood_ironage_bench_back_padded_single_natura_bloodwood 	= FurnitureFactory.CreateWoodPaddedBackBench("chair_wood_ironage_bench_back_padded_single_natura_bloodwood");
				BlockObjectHolder.chair_wood_ironage_bench_back_padded_single_natura_darkwood 	= FurnitureFactory.CreateWoodPaddedBackBench("chair_wood_ironage_bench_back_padded_single_natura_darkwood");
				BlockObjectHolder.chair_wood_ironage_bench_back_padded_single_natura_fusewood 	= FurnitureFactory.CreateWoodPaddedBackBench("chair_wood_ironage_bench_back_padded_single_natura_fusewood");
		...
		if (IronAgeFurnitureConfiguration.INTEGRATION_FORESTRY && Loader.isModLoaded("forestry")) {
			...
			if (IronAgeFurnitureConfiguration.GENERATE_WOOD_BENCHES) {
				...
				BlockObjectHolder.chair_wood_ironage_bench_padded_single_forestry_acacia = FurnitureFactory.CreateWoodPaddedBench("chair_wood_ironage_bench_padded_single_forestry_acacia");
				BlockObjectHolder.chair_wood_ironage_bench_padded_single_forestry_balsa = FurnitureFactory.CreateWoodPaddedBench("chair_wood_ironage_bench_padded_single_forestry_balsa");
				BlockObjectHolder.chair_wood_ironage_bench_padded_single_forestry_baobab = FurnitureFactory.CreateWoodPaddedBench("chair_wood_ironage_bench_padded_single_forestry_baobab");
				BlockObjectHolder.chair_wood_ironage_bench_padded_single_forestry_cherry = FurnitureFactory.CreateWoodPaddedBench("chair_wood_ironage_bench_padded_single_forestry_cherry");
				BlockObjectHolder.chair_wood_ironage_bench_padded_single_forestry_chestnut = FurnitureFactory.CreateWoodPaddedBench("chair_wood_ironage_bench_padded_single_forestry_chestnut");
				BlockObjectHolder.chair_wood_ironage_bench_padded_single_forestry_citrus = FurnitureFactory.CreateWoodPaddedBench("chair_wood_ironage_bench_padded_single_forestry_citrus");
				BlockObjectHolder.chair_wood_ironage_bench_padded_single_forestry_cocobolo = FurnitureFactory.CreateWoodPaddedBench("chair_wood_ironage_bench_padded_single_forestry_cocobolo");
				BlockObjectHolder.chair_wood_ironage_bench_padded_single_forestry_ebony = FurnitureFactory.CreateWoodPaddedBench("chair_wood_ironage_bench_padded_single_forestry_ebony");
				BlockObjectHolder.chair_wood_ironage_bench_padded_single_forestry_giganteum = FurnitureFactory.CreateWoodPaddedBench("chair_wood_ironage_bench_padded_single_forestry_giganteum");
				BlockObjectHolder.chair_wood_ironage_bench_padded_single_forestry_greenheart = FurnitureFactory.CreateWoodPaddedBench("chair_wood_ironage_bench_padded_single_forestry_greenheart");
				...
				BlockObjectHolder.chair_wood_ironage_bench_padded_single_forestry_kapok = FurnitureFactory.CreateWoodPaddedBench("chair_wood_ironage_bench_padded_single_forestry_kapok");
				BlockObjectHolder.chair_wood_ironage_bench_padded_single_forestry_larch = FurnitureFactory.CreateWoodPaddedBench("chair_wood_ironage_bench_padded_single_forestry_larch");
				BlockObjectHolder.chair_wood_ironage_bench_padded_single_forestry_lime = FurnitureFactory.CreateWoodPaddedBench("chair_wood_ironage_bench_padded_single_forestry_lime");
				BlockObjectHolder.chair_wood_ironage_bench_padded_single_forestry_mahoe = FurnitureFactory.CreateWoodPaddedBench("chair_wood_ironage_bench_padded_single_forestry_mahoe");
				BlockObjectHolder.chair_wood_ironage_bench_padded_single_forestry_mahogany = FurnitureFactory.CreateWoodPaddedBench("chair_wood_ironage_bench_padded_single_forestry_mahogany");
				BlockObjectHolder.chair_wood_ironage_bench_padded_single_forestry_maple = FurnitureFactory.CreateWoodPaddedBench("chair_wood_ironage_bench_padded_single_forestry_maple");
				BlockObjectHolder.chair_wood_ironage_bench_padded_single_forestry_padauk = FurnitureFactory.CreateWoodPaddedBench("chair_wood_ironage_bench_padded_single_forestry_padauk");
				BlockObjectHolder.chair_wood_ironage_bench_padded_single_forestry_palm = FurnitureFactory.CreateWoodPaddedBench("chair_wood_ironage_bench_padded_single_forestry_palm");
				BlockObjectHolder.chair_wood_ironage_bench_padded_single_forestry_papaya = FurnitureFactory.CreateWoodPaddedBench("chair_wood_ironage_bench_padded_single_forestry_papaya");
				BlockObjectHolder.chair_wood_ironage_bench_padded_single_forestry_pine = FurnitureFactory.CreateWoodPaddedBench("chair_wood_ironage_bench_padded_single_forestry_pine");
				BlockObjectHolder.chair_wood_ironage_bench_padded_single_forestry_plum = FurnitureFactory.CreateWoodPaddedBench("chair_wood_ironage_bench_padded_single_forestry_plum");
				BlockObjectHolder.chair_wood_ironage_bench_padded_single_forestry_poplar = FurnitureFactory.CreateWoodPaddedBench("chair_wood_ironage_bench_padded_single_forestry_poplar");
				BlockObjectHolder.chair_wood_ironage_bench_padded_single_forestry_sequoia = FurnitureFactory.CreateWoodPaddedBench("chair_wood_ironage_bench_padded_single_forestry_sequoia");
				BlockObjectHolder.chair_wood_ironage_bench_padded_single_forestry_teak = FurnitureFactory.CreateWoodPaddedBench("chair_wood_ironage_bench_padded_single_forestry_teak");
				BlockObjectHolder.chair_wood_ironage_bench_padded_single_forestry_walnut = FurnitureFactory.CreateWoodPaddedBench("chair_wood_ironage_bench_padded_single_forestry_walnut");
				BlockObjectHolder.chair_wood_ironage_bench_padded_single_forestry_wenge = FurnitureFactory.CreateWoodPaddedBench("chair_wood_ironage_bench_padded_single_forestry_wenge");
				BlockObjectHolder.chair_wood_ironage_bench_padded_single_forestry_willow = FurnitureFactory.CreateWoodPaddedBench("chair_wood_ironage_bench_padded_single_forestry_willow");
				BlockObjectHolder.chair_wood_ironage_bench_padded_single_forestry_zebrawood = FurnitureFactory.CreateWoodPaddedBench("chair_wood_ironage_bench_padded_single_forestry_zebrawood");
				...
				BlockObjectHolder.chair_wood_ironage_bench_back_padded_single_forestry_acacia 		= FurnitureFactory.CreateWoodPaddedBackBench("chair_wood_ironage_bench_back_padded_single_forestry_acacia");
				BlockObjectHolder.chair_wood_ironage_bench_back_padded_single_forestry_balsa 		= FurnitureFactory.CreateWoodPaddedBackBench("chair_wood_ironage_bench_back_padded_single_forestry_balsa");
				BlockObjectHolder.chair_wood_ironage_bench_back_padded_single_forestry_baobab 		= FurnitureFactory.CreateWoodPaddedBackBench("chair_wood_ironage_bench_back_padded_single_forestry_baobab");
				BlockObjectHolder.chair_wood_ironage_bench_back_padded_single_forestry_cherry 		= FurnitureFactory.CreateWoodPaddedBackBench("chair_wood_ironage_bench_back_padded_single_forestry_cherry");
				BlockObjectHolder.chair_wood_ironage_bench_back_padded_single_forestry_chestnut 	= FurnitureFactory.CreateWoodPaddedBackBench("chair_wood_ironage_bench_back_padded_single_forestry_chestnut");
				BlockObjectHolder.chair_wood_ironage_bench_back_padded_single_forestry_citrus 		= FurnitureFactory.CreateWoodPaddedBackBench("chair_wood_ironage_bench_back_padded_single_forestry_citrus");
				BlockObjectHolder.chair_wood_ironage_bench_back_padded_single_forestry_cocobolo 	= FurnitureFactory.CreateWoodPaddedBackBench("chair_wood_ironage_bench_back_padded_single_forestry_cocobolo");
				BlockObjectHolder.chair_wood_ironage_bench_back_padded_single_forestry_ebony 		= FurnitureFactory.CreateWoodPaddedBackBench("chair_wood_ironage_bench_back_padded_single_forestry_ebony");
				BlockObjectHolder.chair_wood_ironage_bench_back_padded_single_forestry_giganteum 	= FurnitureFactory.CreateWoodPaddedBackBench("chair_wood_ironage_bench_back_padded_single_forestry_giganteum");
				BlockObjectHolder.chair_wood_ironage_bench_back_padded_single_forestry_greenheart 	= FurnitureFactory.CreateWoodPaddedBackBench("chair_wood_ironage_bench_back_padded_single_forestry_greenheart");
				...
				BlockObjectHolder.chair_wood_ironage_bench_back_padded_single_forestry_kapok 		= FurnitureFactory.CreateWoodPaddedBackBench("chair_wood_ironage_bench_back_padded_single_forestry_kapok");
				BlockObjectHolder.chair_wood_ironage_bench_back_padded_single_forestry_larch 		= FurnitureFactory.CreateWoodPaddedBackBench("chair_wood_ironage_bench_back_padded_single_forestry_larch");
				BlockObjectHolder.chair_wood_ironage_bench_back_padded_single_forestry_lime 		= FurnitureFactory.CreateWoodPaddedBackBench("chair_wood_ironage_bench_back_padded_single_forestry_lime");
				BlockObjectHolder.chair_wood_ironage_bench_back_padded_single_forestry_mahoe 		= FurnitureFactory.CreateWoodPaddedBackBench("chair_wood_ironage_bench_back_padded_single_forestry_mahoe");
				BlockObjectHolder.chair_wood_ironage_bench_back_padded_single_forestry_mahogany 	= FurnitureFactory.CreateWoodPaddedBackBench("chair_wood_ironage_bench_back_padded_single_forestry_mahogany");
				BlockObjectHolder.chair_wood_ironage_bench_back_padded_single_forestry_maple 		= FurnitureFactory.CreateWoodPaddedBackBench("chair_wood_ironage_bench_back_padded_single_forestry_maple");
				BlockObjectHolder.chair_wood_ironage_bench_back_padded_single_forestry_padauk 		= FurnitureFactory.CreateWoodPaddedBackBench("chair_wood_ironage_bench_back_padded_single_forestry_padauk");
				BlockObjectHolder.chair_wood_ironage_bench_back_padded_single_forestry_palm 		= FurnitureFactory.CreateWoodPaddedBackBench("chair_wood_ironage_bench_back_padded_single_forestry_palm");
				BlockObjectHolder.chair_wood_ironage_bench_back_padded_single_forestry_papaya 		= FurnitureFactory.CreateWoodPaddedBackBench("chair_wood_ironage_bench_back_padded_single_forestry_papaya");
				BlockObjectHolder.chair_wood_ironage_bench_back_padded_single_forestry_pine 		= FurnitureFactory.CreateWoodPaddedBackBench("chair_wood_ironage_bench_back_padded_single_forestry_pine");
				BlockObjectHolder.chair_wood_ironage_bench_back_padded_single_forestry_plum 		= FurnitureFactory.CreateWoodPaddedBackBench("chair_wood_ironage_bench_back_padded_single_forestry_plum");
				BlockObjectHolder.chair_wood_ironage_bench_back_padded_single_forestry_poplar 		= FurnitureFactory.CreateWoodPaddedBackBench("chair_wood_ironage_bench_back_padded_single_forestry_poplar");
				BlockObjectHolder.chair_wood_ironage_bench_back_padded_single_forestry_sequoia 		= FurnitureFactory.CreateWoodPaddedBackBench("chair_wood_ironage_bench_back_padded_single_forestry_sequoia");
				BlockObjectHolder.chair_wood_ironage_bench_back_padded_single_forestry_teak 		= FurnitureFactory.CreateWoodPaddedBackBench("chair_wood_ironage_bench_back_padded_single_forestry_teak");
				BlockObjectHolder.chair_wood_ironage_bench_back_padded_single_forestry_walnut 		= FurnitureFactory.CreateWoodPaddedBackBench("chair_wood_ironage_bench_back_padded_single_forestry_walnut");
				BlockObjectHolder.chair_wood_ironage_bench_back_padded_single_forestry_wenge 		= FurnitureFactory.CreateWoodPaddedBackBench("chair_wood_ironage_bench_back_padded_single_forestry_wenge");
				BlockObjectHolder.chair_wood_ironage_bench_back_padded_single_forestry_willow 		= FurnitureFactory.CreateWoodPaddedBackBench("chair_wood_ironage_bench_back_padded_single_forestry_willow");
				BlockObjectHolder.chair_wood_ironage_bench_back_padded_single_forestry_zebrawood 	= FurnitureFactory.CreateWoodPaddedBackBench("chair_wood_ironage_bench_back_padded_single_forestry_zebrawood");
			}
		}
	}
