...
public class ModVanillaLogBench {
	...
	public static RegistryObject<Block> chair_wood_ironage_bench_log_single_pale_oak = register("chair_wood_ironage_bench_log_single_pale_oak", () -> new LogBench(1, 10, SoundType.WOOD, "chair_wood_ironage_bench_log_single_pale_oak"));;
