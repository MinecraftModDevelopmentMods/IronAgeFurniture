...
public final class LegacyPaddedMigrationRegistry {
	public static final TileEntityType<LegacyPaddedBenchTileEntity> padded_bench_colour = null;
	...
	public static void registerTileEntities(RegistryEvent.Register<TileEntityType<?>> event) {
		TileEntityType<LegacyPaddedBenchTileEntity> type = TileEntityType.Builder
				.create(LegacyPaddedBenchTileEntity::new,
						COMPATIBILITY_BLOCKS.toArray(new Block[COMPATIBILITY_BLOCKS.size()]))
				.build(null);
		type.setRegistryName(LegacyPaddedBenchIds.TILE_ENTITY_ID);
