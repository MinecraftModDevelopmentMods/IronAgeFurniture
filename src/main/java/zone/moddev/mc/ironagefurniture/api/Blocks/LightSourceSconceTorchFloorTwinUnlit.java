...
public class LightSourceSconceTorchFloorTwinUnlit extends LightSourceSconceTorchFloorTwin {

    public LightSourceSconceTorchFloorTwinUnlit(Material materialIn, String name, float resistance, float hardness) {
