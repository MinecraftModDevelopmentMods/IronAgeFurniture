...
public final class MetalVariantHelper {
	...
	public static boolean isMetalVariantBlock(Block block) {
		return block instanceof ChainTop
			|| block instanceof zone.moddev.mc.ironagefurniture.api.Blocks.LightHolderSconceFloor
			|| block instanceof LightHolderSconceHanging
			|| block instanceof zone.moddev.mc.ironagefurniture.api.Blocks.LightSourceChandelierCandle
