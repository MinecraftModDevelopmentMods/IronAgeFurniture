...
public class LightSourceCandleWallUnlit extends LightSourceCandleWall {
    public LightSourceCandleWallUnlit(Material materialIn, String name, float resistance, float hardness) {
