...
public class LightSourceChandelierRedstone extends LightSourceChandelierGlowstone {
    ...
    public LightSourceChandelierRedstone(Material materialIn, String name, float resistance, float hardness, int lightLevel) {
    ...
    protected Block getBlockBySignalLevel(int signal) {
        switch (signal) {
            case 1:
                return BlockObjectHolder.chandelier_redstone_one;
            case 2:
                return BlockObjectHolder.chandelier_redstone_two;
            case 3:
                return BlockObjectHolder.chandelier_redstone_three;
            case 4:
                return BlockObjectHolder.chandelier_redstone_four;
            case 5:
                return BlockObjectHolder.chandelier_redstone_five;
            case 6:
                return BlockObjectHolder.chandelier_redstone_six;
            case 7:
                return BlockObjectHolder.chandelier_redstone_seven;
            case 8:
                return BlockObjectHolder.chandelier_redstone_eight;
            case 9:
                return BlockObjectHolder.chandelier_redstone_nine;
            case 10:
                return BlockObjectHolder.chandelier_redstone_ten;
            case 11:
                return BlockObjectHolder.chandelier_redstone_eleven;
            case 12:
                return BlockObjectHolder.chandelier_redstone_twelve;
            case 13:
                return BlockObjectHolder.chandelier_redstone_thirteen;
            case 14:
                return BlockObjectHolder.chandelier_redstone_fourteen;
            case 15:
                return BlockObjectHolder.chandelier_redstone_fifteen;
            default:
                return BlockObjectHolder.chandelier_redstone;
        }
    }
