...
public class LogBench extends BackBench {
	...
	protected void generateShapes(ImmutableList<BlockState> states)
    {
		...
		shapes = VoxelShapes.joinUnoptimized(shapes, getShapes(rotate(Block.box(0, 0, 1, 16, 7, 15), Direction.SOUTH))[state.getValue(DIRECTION).get2DDataValue()], IBooleanFunction.OR);
