...
public class LegacyPaddedBenchIdsTest {
	...
	@Test
	public void doesNotClaimAnotherModsNamespace() {
		ResourceLocation addon = new ResourceLocation("iafbygaddon",
				"chair_wood_ironage_classic_byg_aspen");
		assertEquals(addon, LegacyPaddedBenchIds.currentId(addon));
		assertFalse(LegacyPaddedBenchIds.isLegacyNamespace(addon.getNamespace()));
	}
}
